...
filepaths = ['upload_1.csv', 'upload_2.csv', 'upload_3.csv', 'upload_4.csv', 'upload_5.csv', 'upload_6.csv', 'upload_7.csv', 'upload_8.csv', 'upload_9.csv', 'upload_10.csv', 'upload_11.csv', 'upload_12.csv']
